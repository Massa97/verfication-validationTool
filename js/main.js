...
E(document).ready(function () {
    ...
    // DEFAULTS
    // ------------------------------
    var defaultHTML = '<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js\">\n</script><script src="https://cdnjs.cloudflare.com/ajax/libs/mermaid/8.9.3/mermaid.min.js"></script>\n<div class="mermaid">\n</div>',
        defaultCSS = ' ',
    ...
    // save as pdf file
    for (let elem of document.querySelectorAll('.savePDF')) {
